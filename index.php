...
<?php include $_SERVER["DOCUMENT_ROOT"]."/dy_pofol/include/header.php";?>
  ...
  <div id="fullpage">
      ...
      <!-- End of 1st Section -->
      <div class="section pgnum_2" data-anchor="1st">
        <div class="center">
          ...
          <div class="main2_contents">
            ...
            <div class="container">
              ...
              <div class="skill_btn">
                <button>View My Skill</button>
              </div>
            </div>
            <!-- End of Card Wrap Html -->
          </div>
          
          <!-- End of main2_section Html -->
          
        </div>
        <!-- End of Center Html -->
      </div>
      <div class="section pgnum_3" data-anchor="2nd">
        <div class="center">
  ...
  <script src="/dy_pofol/js/main.js"></script>
